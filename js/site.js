(function () {
  ...
  const links = [['index.html','Home'],['draft.html','Draft HQ'],['teams.html','Teams'],['standings.html','Standings'],['matchups.html','Matchups'],['rules.html','Rules'],['gazette.html','Gazette'],['records.html','Records']];
