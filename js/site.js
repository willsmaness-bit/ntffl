(function () {
  ...
  const titles = {
    ...
    'votes.html': 'Board · Sunday Scaries',
  ...
  const desc = 'Sunday Scaries FFL. Auction complete. 8-team half-PPR superflex. $30 buy-in. Rosters live on Sleeper.';
  ...
  const links = [['index.html','Home'],['draft.html','Results'],['teams.html','Teams'],['standings.html','Standings'],['rules.html','Rules'],['gazette.html','Gazette'],['votes.html','Board']];
